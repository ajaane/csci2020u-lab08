...
public class DataSource {
    ...
    public static ObservableList<com.example.lab08.StudentRecord> getMark(String id, float assignment, float midterm, float finalExam) {
        ObservableList<com.example.lab08.StudentRecord> mark = FXCollections.observableArrayList();

        mark.add(new com.example.lab08.StudentRecord(id, assignment, midterm, finalExam));
